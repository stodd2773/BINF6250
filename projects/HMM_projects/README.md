...
## Group Leader
Spencer: 
PROJECT 08 - VITERBI: I enjoyed this project, having no set structure and guidance as I think it emphasized the need for teamwork and made us leverage the skills we already have. I am looking forward to the following weeks working with Marcos and Sneha!
...
PROJECT 10 - BAUM-WELCH: The Baum-Welch algorithm was a bit more difficult for me to understand conceptually compared to the past two weeks. As mentioned in our struggles, it was challenging to interpret the outputs of out test because it seemed that it was reaching convergence quickly, and we were not sure if it was because we were using a small example or if there was something wrong with out implementation. 
